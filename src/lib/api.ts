...
export const api = {
    ...
    fetchBadges: async (lastSeen: UserActivity) => {
        try {
            ...
            return { unreadForum: 0, unreadEvents: 0, unreadPackages: 0 };
        }
    },
    ...
    togglePostUseful: async (postId: string, userId: string) => {
        try {
            ...
            console.error('Error toggling post useful:', error);
            return { voted: false };
        }
    },
    ...
    toggleCommentUseful: async (commentId: string, userId: string) => {
        try {
            ...
            if (existingVote) {
                ...
                const { data: comment } = await supabase.from('forum_comments').select('upvotes').eq('id', commentId).maybeSingle();
                if (comment) {
    ...
    createPackageReport: async (report: any, imageFile?: File | null) => {
        try {
            ...
            console.error('Error creating package report:', error);
            return { error };
        }
    },
    ...
    fetchPackageComments: async (packageId: string) => {
        try {
            ...
            console.error('Error fetching package comments:', error);
            return null;
        }
    },
    ...
    incrementMarketplaceItemView: async (itemId: string) => {
        try {
            ...
            console.error('Error incrementing marketplace item view:', error);
            return null;
        }
    },
    ...
    toggleMarketplaceItemLike: async (itemId: string, userId: string) => {
        try {
            ...
            console.error('Error toggling marketplace item like:', error);
            return { error };
        }
    },
    ...
    toggleMarketplaceCommentUseful: async (commentId: string, userId: string) => {
        try {
            ...
            console.error('Error toggling marketplace comment useful:', error);
            return { voted: false };
        }
    },
    ...
    fetchDevSupportTickets: async () => {
        try {
            ...
            console.error('Error fetching dev support tickets:', error);
            return null;
        }
    },
    ...
    createDevSupportTicket: async (ticket: Omit<DevSupportTicket, 'id' | 'created_at' | 'updated_at' | 'user_id' | 'upvotes' | 'is_liked_by_me'>, userId: string) => {
        try {
            ...
            console.error('Error creating dev support ticket:', error);
            return { error };
        }
    },
    ...
    toggleDevSupportTicketVote: async (ticketId: string, userId: string) => {
        try {
            ...
            console.error('Error toggling dev support ticket vote:', error);
            return { voted: false };
        }
    },
    ...
    fetchDevSupportComments: async (ticketId: string) => {
        try {
            ...
            console.error('Error fetching dev support comments:', error);
            return null;
        }
    },
    ...
    fetchAdminUsers: async (): Promise<AdminUser[] | null> => {
        try {
            ...
            console.error('Error executing fetchAdminUsers:', error);
            return null;
        }
    },
